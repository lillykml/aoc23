...
while not loop:
    if not incoming_directions:
        new_coordinates, incoming_directions = first_step(s, coordinates[0])
    else:
        new_coordinates, incoming_directions = find_next_elements(maze, coordinates, incoming_directions)

    # Replace elements with 1
    for element in coordinates:
        maze[element[0]][element[1]] = 1
